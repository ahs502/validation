...
import { getBadgeMessage, Chain, AsyncHandler, PendingHandler } from './_utils';
...
export default class Validator<Badge extends string, $ extends {}, Data = undefined> {
  ...
  do<T>(
    task: Data extends [(infer D0), (infer D1), (infer D2), (infer D3), (infer D4), (infer D5), (infer D6), (infer D7), (infer D8), (infer D9)]
      ? (item0: D0, item1: D1, item2: D2, item3: D3, item4: D4, item5: D5, item6: D6, item7: D7, item8: D8, item9: D9) => T
      : Data extends [(infer D0), (infer D1), (infer D2), (infer D3), (infer D4), (infer D5), (infer D6), (infer D7), (infer D8)]
      ? (item0: D0, item1: D1, item2: D2, item3: D3, item4: D4, item5: D5, item6: D6, item7: D7, item8: D8) => T
      : Data extends [(infer D0), (infer D1), (infer D2), (infer D3), (infer D4), (infer D5), (infer D6), (infer D7)]
      ? (item0: D0, item1: D1, item2: D2, item3: D3, item4: D4, item5: D5, item6: D6, item7: D7) => T
      : Data extends [(infer D0), (infer D1), (infer D2), (infer D3), (infer D4), (infer D5), (infer D6)]
      ? (item0: D0, item1: D1, item2: D2, item3: D3, item4: D4, item5: D5, item6: D6) => T
      : Data extends [(infer D0), (infer D1), (infer D2), (infer D3), (infer D4), (infer D5)]
      ? (item0: D0, item1: D1, item2: D2, item3: D3, item4: D4, item5: D5) => T
      : Data extends [(infer D0), (infer D1), (infer D2), (infer D3), (infer D4)]
      ? (item0: D0, item1: D1, item2: D2, item3: D3, item4: D4) => T
      : Data extends [(infer D0), (infer D1), (infer D2), (infer D3)]
      ? (item0: D0, item1: D1, item2: D2, item3: D3) => T
      : Data extends [(infer D0), (infer D1), (infer D2)]
      ? (item0: D0, item1: D1, item2: D2) => T
