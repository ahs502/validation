...
export default interface IValidatorChain<Badge extends string, $ extends $Base, Data> {
  with<T>(target: T | PromiseLike<T>): IValidatorChain<Badge, $, T>;
  object<T = Data>(target?: T | PromiseLike<T>): IValidatorChain<Badge, $, T>;
  array<T = Data>(target?: T | PromiseLike<T>): IValidatorChain<Badge, $, T>;
  then<T>(task: (data: Data) => T | PromiseLike<T> | IValidator<Badge, $, T>): IValidatorChain<Badge, $, T>;
  do<T>(
    task: Data extends []
  ...
  ): IValidatorChain<Badge, $, [T0, T1, T2, T3, T4]>;
  ...
  ): IValidatorChain<Badge, $, [T0, T1, T2, T3, T4, T5]>;
  ...
  ): IValidatorChain<Badge, $, [T0, T1, T2, T3, T4, T5, T6]>;
  ...
  ): IValidatorChain<Badge, $, [T0, T1, T2, T3, T4, T5, T6, T7]>;
  ...
  ): IValidatorChain<Badge, $, [T0, T1, T2, T3, T4, T5, T6, T7, T8]>;
  ...
  ): IValidatorChain<Badge, $, [T0, T1, T2, T3, T4, T5, T6, T7, T8, T9]>;

  check(badge: Badge, validity: boolean | ((data: Data) => boolean), message?: string | ((data: Data) => string)): IValidatorChain<Badge, $, Data>;
  earn(badge: Badge): IValidatorChain<Badge, $, Data>;
  fail(badge: Badge, message?: string | ((data: Data) => string)): IValidatorChain<Badge, $, Data>;
  when(...badges: Badge[]): IValidatorChain<Badge, $, Data>;
  must(...conditions: (boolean | ((data: Data) => boolean))[]): IValidatorChain<Badge, $, Data>;
  if(...conditions: (boolean | ((data: Data) => boolean))[]): IValidatorChain<Badge, $, Data>;
  end(): Promise<Data>;
